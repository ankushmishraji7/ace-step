...
def process_audio(
    ...
    def extract_pipeline_hyperparameters(generator_data: dict) -> dict:
        return {
            "audio_duration": generator_data.get("audio_duration", 60.0),
            "prompt": generator_data.get("prompt", ""),
            "lyrics": generator_data.get("lyrics", ""),
    ...
    try:
        ...
        hyperparameters = extract_pipeline_hyperparameters(sampled_data)
